...
set $xslt=".\Junos-fw-rules.xslt"
set $html_output=".\output\2015-08-17-FW-Rules.html"

%SystemRoot%\system32\WindowsPowerShell\v1.0\powershell.exe -ExecutionPolicy Bypass -Command ".\Transform-XML.ps1 -xml %$xml_input% -xsl %$xslt% -output %$html_output%"
echo Done!
pause